...
//           setBlogBanner(data.image); // Assuming the API returns the image path as part of the blog data
//         } catch (error) {
...
//       // Optionally, handle post-update actions like showing a success message or redirecting
//       setError(null);
//     } catch (error) {
...
//             />
//             {/* {blogBanner && typeof blogBanner === 'string' && (
//               <img src={blogBanner} alt="Current Blog Banner" className="mt-2 w-32 h-32 object-cover" />
//             )} */}
//           </div>
//           <div className="flex flex-col">
