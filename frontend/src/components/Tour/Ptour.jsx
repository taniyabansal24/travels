...
//                   <FontAwesomeIcon
//                     icon={
//                       expandedDays.includes(index) ? faChevronUp : faChevronDown
//                     }
//                     className="mr-2"
//                   />
//                   Day {day.day}: {day.title}
//                 </h3>
//                 <p className="md:text-lg mb-2 cursor-pointer text-sm">
//                   {day.description}
//                 </p>
//               </div>
...
//                             <img
//                               src={
//                                 sight.image || "default-sightseeing-image.jpg"
//                               }
//                               alt={sight.location}
//                               className="card_image w-1/3 mr-4 object-cover rounded-md"
//                             />
...
const Ptour = (props) => {
  const { id } = useParams();
  const tourPackage = props.data.find((post) => post.name === id);
  ...
  const handleMove = (direction) => {
    setSlideNumber((prev) =>
      direction === "l"
        ? prev === 0
          ? tourPackage.photos.length - 1
          : prev - 1
        : prev === tourPackage.photos.length - 1
        ? 0
        : prev + 1
    );
  };
  ...
  return (
    <div className="page">
      ...
      <div className="top flex flex-col md:flex-row">
        ...
        <div className="relative w-full md:w-9/10 flex flex-wrap justify-between">
          {open && (
            <div className="slider mb-2.5 w-full h-[64vh]">
              ...
              <div className="sliderWrapper">
                <img
                  src={tourPackage.photos[slideNumber].src}
                  alt=""
                  className="w-[98%] h-[59vh] object-cover"
                />
              </div>
        ...
        <div className="context">
          <div className="w-full">
            <h2 className="text-4xl font-extrabold mb-2">{tourPackage.name}</h2>
            <p className="text-xl text-blue-700 mb-4 font-bold">
              {tourPackage.price}
            </p>
            <hr className="mb-4" />
      ...
      <div className="main flex flex-col md:flex-row">
        ...
        <div className="tour_plan md:w-3/4">
          ...
          {tourPackage.tourPlan.map((day, index) => (
